...
# tuning parameters
tune <- c(10, 10, 10, # alpha coefficients and sigma
          10, 10, # gamma coefficients
          10, # psi1 coefficients
          10, 10, 10, 10, 10, # epsilon coefficients
          7, 7, 7, 7) #a0 and season parameters (detection)
...
saveRDS(return_list,paste0(Sys.Date(),"_sd10_a7.rds"))
