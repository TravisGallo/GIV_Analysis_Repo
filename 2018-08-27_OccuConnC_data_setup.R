...
ndvi_coarse <- aggregate(raster("./Data/NDVI_to_Resistence.tif"), fact=30, fun=mean) # scale up raster to 900x900
...
pop10_coarse <- aggregate(raster("./Data/CMAP_PHH10.tif"), fact=30, fun=mean)
...
saveRDS(data_list, "2018-08-24_occusampler_data.RDS")
