...
dynroccH <- function(y,            # nsampled x nseason matrix of detection data*
                     ...
                     x,            # nSites x 2 matrix of site coordinates. 
                                   #  Note that nSampled will usually be <nSites*
                     ...
                     tune,         # Tuning order: sigma,gamma0.i,gamma0.s,gamma0.
                                   #               p,eps.i,eps.s,eps.p,
                                   #               beta0,beta1,beta2,alpha[1],
                                   #               alpha[2] (12 in total)
